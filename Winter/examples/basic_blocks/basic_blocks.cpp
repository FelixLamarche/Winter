...
int main()
{
	...
	const std::string PATH_VERTEX_SHADER = PathManager::getProjectPath() + "examples/basic_blocks/basicVertexShader.glsl";
	const std::string PATH_FRAGMENT_SHADER = PathManager::getProjectPath() + "examples/basic_blocks/basicFragmentShader.glsl";
