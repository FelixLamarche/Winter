...
int main()
{
	...
	const std::string PATH_EXAMPLE = PathManager::getProjectPath() + "examples/normal_map/";

	const std::string PATH_VERTEX_SHADER = PATH_EXAMPLE + "basicNormalMap.vert";
	const std::string PATH_FRAGMENT_SHADER = PATH_EXAMPLE + "basicNormalMap.frag";
    ...
    while (!glfwWindowShouldClose(window))
    {
		...
		glBindTexture(GL_TEXTURE_2D, brickWallTextureSpec);
