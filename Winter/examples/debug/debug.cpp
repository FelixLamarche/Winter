...
int main()
{
	...
	const std::string PATH_FOLDER = PathManager::getProjectPath() + "examples/debug/";

    const std::string PATH_SKYBOX_VERTEX_SHADER = PATH_FOLDER + "skybox.vert";
    const std::string PATH_SKYBOX_FRAGMENT_SHADER = PATH_FOLDER + "skybox.frag";
    const std::string PATH_PBR_VERTEX_SHADER = PATH_FOLDER + "pbr.vert";
    const std::string PATH_PBR_FRAGMENT_SHADER = PATH_FOLDER + "pbr.frag";
	const std::string PATH_PBR_TEXTURES_FRAGMENT_SHADER = PATH_FOLDER + "pbrTextures.frag";
    const std::string PATH_EQUIRECTANGULAR_TO_CUBEMAP_VERTEX_SHADER = PATH_FOLDER + "equirectangularToCubemap.vert";
    const std::string PATH_EQUIRECTANGULAR_TO_CUBEMAP_FRAGMENT_SHADER = PATH_FOLDER + "equirectangularToCubemap.frag";
	const std::string PATH_IRRADIANCE_CONVOLUTION_FRAGMENT_SHADER = PATH_FOLDER + "irradianceConvolution.frag";
	const std::string PATH_PREFILTER_FRAGMENT_SHADER = PATH_FOLDER + "prefilter.frag";
	const std::string PATH_BRDF_VERTEX_SHADER = PATH_FOLDER + "brdf.vert";
	const std::string PATH_BRDF_FRAGMENT_SHADER = PATH_FOLDER + "brdf.frag";
