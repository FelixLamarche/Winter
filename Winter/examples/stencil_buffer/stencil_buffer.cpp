...
int main()
{
	...
	const std::string PATH_EXAMPLE = PathManager::getProjectPath() + "examples/stencil_buffer/";
    ...
    const std::string PATH_DEPTH_FRAGMENT_SHADER = PATH_EXAMPLE + "depthFragmentShader.glsl";
    const std::string PATH_COLOR_VERTEX_SHADER = PATH_EXAMPLE + "singleColorVertexShader.glsl";
    const std::string PATH_COLOR_FRAGMENT_SHADER = PATH_EXAMPLE + "singleColorFragmentShader.glsl";
    ...
    Shader singleColorShader(PATH_COLOR_VERTEX_SHADER, PATH_COLOR_FRAGMENT_SHADER);
    Shader screenShader(PATH_SCREEN_VERTEX_SHADER, PATH_SCREEN_FRAGMENT_SHADER);

    singleColorShader.use();
	glm::vec3 colorHighlight(0.0f, 0.0f, 0.77f);
	singleColorShader.setVec3("color", colorHighlight);
    ...
    cube.AddTexture(Texture(container2Texture, "texture_diffuse", PATH_TEXTURE_CONTAINER2));
    cube.AddTexture(Texture(container2Specular, "texture_specular", PATH_TEXTURE_CONTAINER2_SPECULAR));
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // Draw from Stencil Buffer highlights
        ...
        singleColorShader.setMat4("model", value_ptr(model));
        singleColorShader.setMat4("view", value_ptr(view));
        singleColorShader.setMat4("projection", value_ptr(projection));
		backpackModel.draw(singleColorShader);
